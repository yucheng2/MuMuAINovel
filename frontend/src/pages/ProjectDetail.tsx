      ...
      children: [
        {
          ...
          icon: <GlobalOutlined />,
          label: (
            <Link to={`/project/${projectId}/world-setting`}>世界设定</Link>
          ),
        },
        {
          key: "characters",
        ...
        },
        {
          ...
          icon: <BankOutlined />,
          label: (
            <Link to={`/project/${projectId}/organizations`}>组织管理</Link>
          ),
        },
        {
          key: "careers",
        ...
        },
        {
          ...
          label: (
            <Link to={`/project/${projectId}/relationships`}>关系管理</Link>
          ),
        },
        {
          key: "outline",
        ...
        },
        {
          ...
          icon: <FundOutlined />,
          label: (
            <Link to={`/project/${projectId}/chapter-analysis`}>剧情分析</Link>
          ),
        },
        {
          key: "foreshadows",
      ...
      children: [
        {
          ...
          icon: <EditOutlined />,
          label: (
            <Link to={`/project/${projectId}/writing-styles`}>写作风格</Link>
          ),
        },
        {
          key: "prompt-workshop",
          icon: <CloudOutlined />,
          label: (
            <Link to={`/project/${projectId}/prompt-workshop`}>提示词工坊</Link>
          ),
        },
      ],
    },
